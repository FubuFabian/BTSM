...
for i=1:nImages
    ...
    [itensityProbs textureProbs] = TrainingMeanProbabilities(trainingImages,trainingTumors);
    
    testImage = images{i};
    [segmentedTumorEdge segmentedTumorImage] = BreastTumorSegmentation(testImage,itensityProbs,textureProbs);
