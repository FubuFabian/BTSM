function out = TestIntensityOneImage()
...
%for i=1:nImages
    ...
    [itensityProbs] = TrainingMeanProbabilitiesIntensity(trainingImages,trainingTumors);
    
    testImage = images{2};
    [segmentedTumorEdge segmentedTumorImage] = BreastTumorSegmentationIntensity(testImage,itensityProbs);
...
%    statistics(i,:) = [accuracy sensibility specificity PPV NPV];
    ...
    imwrite(segmentedImage,'C:/Users/Public/Documents/Breast Tumor Segmentation/Tumor Segmentation Matlab/Resultados/Homogeneous/Imagenes/Segmentacion/homo1_y_Mean_Segmentacion.bmp');
