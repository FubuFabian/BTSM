...
%for i=1:nImages
    ...
    [itensityProbs textureProbs] = TrainingMeanProbabilities(trainingImages,trainingTumors,'LRE');
    
    testImage = images{2};
    [segmentedTumorEdge segmentedTumorImage] = BreastTumorSegmentation(testImage,itensityProbs,textureProbs,'LRE');
...
%    statistics(i,:) = [accuracy sensibility specificity PPV NPV];
    ...
    imwrite(segmentedImage,'C:/Users/Public/Documents/Breast Tumor Segmentation/Tumor Segmentation Matlab/Resultados/Homogeneous/Imagenes/Segmentacion/homo1_y_LRE_Segmentacion.bmp');
    
    imagen = figure, imshow(testImage), title('Tumor Borders') 
    hold all
