function out = TestRunlength(images,tumors,nImages,descriptor)
...
for i=1:nImages
    ...
    [itensityProbs textureProbs] = TrainingMeanProbabilities(trainingImages,trainingTumors,descriptor);
    
    testImage = images{i};
    [segmentedTumorEdge segmentedTumorImage] = BreastTumorSegmentation(testImage,itensityProbs,textureProbs,descriptor);
