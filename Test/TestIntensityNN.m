function out = TestIntensityNN(intensityImages,tumors)
...
for i=1:nImages
    ...
    trainingImages = intensityImages;
    trainingImages(i,:) = [];

    trainingTumors = tumors;
    trainingTumors(i,:) = [];
    
    net = TrainingNeuralNetworkIntensity(trainingImages,trainingTumors);
    
    testImage = intensityImages{i};
    [segmentedTumorEdge segmentedTumorImage] = BreastTumorSegmentationNNIntensity(testImage,net);
