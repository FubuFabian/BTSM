function [out] = TestHaralickTextureDescriptor(descriptor)
...
for i=1:nImages
    ...
    [imTexture time(i)] = HaralickTexture(imGray,descriptor);
        
    %imwrite(imTexture,strcat(savePath,'/Imagenes/Haralick/',descriptor,'/',fileImages{i}(1:end-4),'_',descriptor,'.bmp'));    
...
save(strcat(savePath,'/Probabilidades/Haralick/',descriptor,'/','tumor_',descriptor,'.mat'),'meanTumorProbability');
save(strcat(savePath,'/Probabilidades/Haralick/',descriptor,'/','background_',descriptor,'.mat'),'meanTumorProbability');
...
print (graf, '-dbmp', strcat(savePath,'/Graficas/Haralick/',descriptor,'/','Probabilidad_',descriptor,'.bmp')) 