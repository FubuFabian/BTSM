function [out] = TestBayesClassifier(descriptor)
...
savePath = 'C:/Users/Fubu/Documents/TumorSegmentation/Pruebas/Resultados/Homogeneous';
...
for i=1:nImages
    ...
    [imBayes timeClassifier(i)] = BayesClassifier(imIntensity,imTexture,stats,descriptor);

    imwrite(imBayes,strcat(savePath,'/Imagenes/Bayes/',descriptor,'/',fileImages{i}(1:end-4),'_',descriptor,'.bmp'));    
    ...
    if(strcmp(descriptor,'Probabilidad'))
        ...
        backgroundImage = imBayes(background);
    ...
    elseif(strcmp(descriptor,'Clasificacion'))
        ...
        classifiedTumors{i} = find(imBayes);
...
if(strcmp(descriptor,'Probabilidad'))
    ...
    save(strcat(savePath,'/Probabilidades/Bayes/',descriptor,'/','tumor_',descriptor,'.mat'),'meanTumorProbability');
    save(strcat(savePath,'/Probabilidades/Bayes/',descriptor,'/','background_',descriptor,'.mat'),'meanBackgroundProbability');
    ...
    print (graf, '-dbmp', strcat(savePath,'/Graficas/Bayes/',descriptor,'/','Bayes_',descriptor,'.bmp')) 
...
elseif(strcmp(descriptor,'Clasificacion'))
    ...
    print (h, '-dbmp', strcat(savePath,'/Graficas/Bayes/',descriptor,'/','Bayes_',descriptor,'.bmp'))
