function [out] = TestHistogramDescriptor(descriptor)
...
for i=1:nImages
    ...
    [imTexture time(i)] = HistogramTexture(imGray,descriptor);
        
    imwrite(imTexture,strcat(savePath,'/Imagenes/Histogram/',descriptor,'/',fileImages{i}(1:end-4),'_',descriptor,'.bmp'));    
...
save(strcat(savePath,'/Probabilidades/Histogram/',descriptor,'/','tumor_',descriptor,'.mat'),'meanTumorProbability');
save(strcat(savePath,'/Probabilidades/Histogram/',descriptor,'/','background_',descriptor,'.mat'),'meanBackgroundProbability');
...
print (graf, '-dbmp', strcat(savePath,'/Graficas/Histogram/',descriptor,'/','Probabilidad_',descriptor,'.bmp')) 